...
- 2026-08-20: Implemented path resolution mapping for renamed files during co-change parsing (resolve_renamed_path, build_rename_map_from_history, parse_numstat_rename) in graph_builder.py and commit_walker.py to prevent file renames from splitting co-change coupling metrics into separate files (#398).
