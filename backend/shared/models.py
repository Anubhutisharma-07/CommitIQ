...
class Commit(Base):
    ...
    health_snapshot = relationship("HealthSnapshot", back_populates="commit", uselist=False, cascade="all, delete-orphan")
    ...
    llm_narratives  = relationship("LLMNarrative", back_populates="commit", cascade="all, delete-orphan")
