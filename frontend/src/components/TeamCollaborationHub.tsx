...
function generateMockReviewMetrics(): ReviewMetric[] {
  return [
    { reviewer: 'Alice Chen', avatar: '👩‍💻', reviewsDone: 87, avgTurnaroundHrs: 2.1, approvalRate: 72, commentsGiven: 342, linesReviewed: 12400, helpfulnessScore: 94 },
    { reviewer: 'Bob Smith', avatar: '👨‍💻', reviewsDone: 65, avgTurnaroundHrs: 4.8, approvalRate: 68, commentsGiven: 198, linesReviewed: 8200, helpfulnessScore: 82 },
    { reviewer: 'Carol White', avatar: '👩‍🔬', reviewsDone: 72, avgTurnaroundHrs: 3.2, approvalRate: 75, commentsGiven: 287, linesReviewed: 10100, helpfulnessScore: 91 },
    { reviewer: 'David Brown', avatar: '🧑‍💻', reviewsDone: 43, avgTurnaroundHrs: 6.5, approvalRate: 82, commentsGiven: 98, linesReviewed: 4800, helpfulnessScore: 76 },
    { reviewer: 'Eva Martinez', avatar: '👩‍🎨', reviewsDone: 78, avgTurnaroundHrs: 2.8, approvalRate: 70, commentsGiven: 310, linesReviewed: 11200, helpfulnessScore: 89 },
    { reviewer: 'Frank Lee', avatar: '👨‍🔧', reviewsDone: 55, avgTurnaroundHrs: 3.9, approvalRate: 78, commentsGiven: 165, linesReviewed: 7400, helpfulnessScore: 85 },
    { reviewer: 'Grace Kim', avatar: '👩‍🏫', reviewsDone: 91, avgTurnaroundHrs: 1.8, approvalRate: 65, commentsGiven: 420, linesReviewed: 14800, helpfulnessScore: 96 },
  ]
}

function generateMockCodeOwners(): CodeOwner[] {
  return [
    { area: 'Frontend Core', icon: '⚛️', primaryOwner: 'Alice Chen', contributors: ['Bob Smith', 'Eva Martinez'], coveragePct: 92, lastActivity: '2 hours ago', riskLevel: 'low' },
    { area: 'Backend API', icon: '🔧', primaryOwner: 'Bob Smith', contributors: ['Carol White', 'Frank Lee'], coveragePct: 78, lastActivity: '5 hours ago', riskLevel: 'low' },
    { area: 'Database Layer', icon: '🗄️', primaryOwner: 'Carol White', contributors: ['David Brown'], coveragePct: 65, lastActivity: '1 day ago', riskLevel: 'medium' },
    { area: 'DevOps/CI', icon: '🚀', primaryOwner: 'David Brown', contributors: [], coveragePct: 45, lastActivity: '3 days ago', riskLevel: 'high' },
    { area: 'Auth & Security', icon: '🔐', primaryOwner: 'Eva Martinez', contributors: ['Grace Kim'], coveragePct: 88, lastActivity: '12 hours ago', riskLevel: 'low' },
    { area: 'Testing', icon: '🧪', primaryOwner: 'Grace Kim', contributors: ['Alice Chen', 'Carol White'], coveragePct: 82, lastActivity: '8 hours ago', riskLevel: 'low' },
    { area: 'Documentation', icon: '📝', primaryOwner: 'Frank Lee', contributors: ['Grace Kim', 'Bob Smith'], coveragePct: 58, lastActivity: '2 days ago', riskLevel: 'medium' },
  ]
}

function generateMockKnowledgeNodes(): KnowledgeNode[] {
  return [
    { name: 'Alice Chen', avatar: '👩‍💻', modules: ['Frontend Core', 'Testing', 'Auth'], crossModulePct: 78, knowledgeDepth: 88, mentoring: 12 },
    { name: 'Bob Smith', avatar: '👨‍💻', modules: ['Backend API', 'Database', 'Documentation'], crossModulePct: 62, knowledgeDepth: 75, mentoring: 8 },
    { name: 'Carol White', avatar: '👩‍🔬', modules: ['Database', 'Backend API', 'Testing'], crossModulePct: 71, knowledgeDepth: 82, mentoring: 15 },
    { name: 'David Brown', avatar: '🧑‍💻', modules: ['DevOps/CI', 'Database'], crossModulePct: 35, knowledgeDepth: 68, mentoring: 3 },
    { name: 'Eva Martinez', avatar: '👩‍🎨', modules: ['Auth', 'Frontend Core', 'Backend API'], crossModulePct: 85, knowledgeDepth: 90, mentoring: 18 },
    { name: 'Frank Lee', avatar: '👨‍🔧', modules: ['Documentation', 'Backend API', 'Testing'], crossModulePct: 55, knowledgeDepth: 72, mentoring: 6 },
    { name: 'Grace Kim', avatar: '👩‍🏫', modules: ['Testing', 'Auth', 'Documentation', 'Frontend Core'], crossModulePct: 92, knowledgeDepth: 85, mentoring: 22 },
  ]
}
...
function ReviewLoadBar({ reviewer, reviews, maxReviews }: { reviewer: string; reviews: number; maxReviews: number }) {
...
function ActivityHeatmapCell({ value }: { value: number }) {
  ...
  const color = value > 70 ? '#8b5cf6' : value > 40 ? '#6366f1' : value > 10 ? '#4f46e5' : 'rgba(255,255,255,0.03)'
  return (
    <div
...
export default function TeamCollaborationHub() {
  const [activeTab, setActiveTab] = useState<'reviews' | 'ownership' | 'knowledge' | 'activity'>('reviews')
  ...
  const teamMetrics: TeamMetric[] = [
    ...
    { label: 'Review Load', value: 'Balanced', icon: '⚖️', trend: 'stable', delta: 'No bottlenecks' },
          ...
          <div className="glass-panel rounded-2xl p-6">
            ...
            <div className="space-y-2">
              {reviewMetrics
                ...
                .map((r, i) => (
                  <div key={r.reviewer} className="flex items-center gap-3 p-2 rounded-lg hover:bg-white/5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-slate-400">{r.commentsGiven} comments • {r.linesReviewed.toLocaleString()} lines</div>
                    </div>
                    ...
                    .map((r) => (
                      <tr key={r.reviewer} className="border-t border-white/5 hover:bg-white/5">
                        ...
                        <td className="text-right py-3">
                          <span className={r.avgTurnaroundHrs < 3 ? 'text-green-400' : r.avgTurnaroundHrs < 5 ? 'text-yellow-400' : 'text-red-400'}>
                        ...
                        <td className="text-right py-3 text-slate-300">{r.linesReviewed.toLocaleString()}</td>
                        <td className="text-right py-3">
                          <span className={`font-semibold ${r.helpfulnessScore >= 90 ? 'text-green-400' : r.helpfulnessScore >= 80 ? 'text-yellow-400' : 'text-slate-300'}`}>
          ...
          <div className="glass-panel rounded-2xl p-6">
            ...
            <div className="space-y-2">
              {reviewMetrics
                .sort((a, b) => b.reviewsDone - a.reviewsDone)
                .map((r) => (
                  <ReviewLoadBar key={r.reviewer} reviewer={r.reviewer} reviews={r.reviewsDone} maxReviews={maxReviews} />
                ))}
            </div>
            <p className="text-xs text-slate-500 mt-3">⚠️ Orange indicates overloaded reviewers — redistribute if possible</p>
          </div>
        </div>
      )}
      ...
      {activeTab === 'ownership' && (
        <div className="space-y-6">
          ...
          <div className="glass-panel rounded-2xl p-6">
            ...
            <div className="space-y-3">
              {codeOwners.map((owner) => (
                <div key={owner.area} className="p-4 rounded-xl bg-white/5 hover:bg-white/8 transition-all">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs mt-3">
                    ...
                    <div>
                      ...
                      <div className="text-white font-medium">{owner.contributors.length > 0 ? owner.contributors.join(', ') : 'None'}</div>
                    </div>
                    <div>
          ...
          <div className="glass-panel rounded-2xl p-6">
            ...
            <p className="text-xs text-slate-400 mb-4">How many people could get hit by a bus before a module has no experts?</p>
              ...
              {codeOwners.map((owner) => {
                ...
                return (
                  <div key={owner.area} className="p-3 rounded-lg bg-white/5 text-center">
                    <div className="text-3xl font-black" style={{ color }}>{busFactor}</div>
                    <div className="text-xs text-slate-300 font-medium">{owner.icon} {owner.area}</div>
                    <div className="text-xs text-slate-500">{busFactor < 2 ? '⚠️ Single point of failure' : busFactor < 3 ? 'Could use more coverage' : 'Well covered'}</div>
                  </div>
                )
              })}
            </div>
                  ...
                  <div key={node.name} className="p-3 rounded-xl bg-white/5">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-slate-400">Modules: {node.modules.join(', ')}</div>
                      </div>
                      <div className="text-right">
                        <div className="text-lg font-bold text-purple-400">{node.crossModulePct}%</div>
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-2">
                      <div className="text-center">
                        ...
                        <div className="text-sm font-bold text-white">{node.knowledgeDepth}/100</div>
                      </div>
                      <div className="text-center">
                        <div className="text-xs text-slate-400">Mentoring</div>
                        <div className="text-sm font-bold text-white">{node.mentoring} sessions</div>
                      </div>
                      <div className="text-center">
          ...
          <div className="glass-panel rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                <div className="text-sm font-semibold text-green-400">✅ Well-Distributed Knowledge</div>
              ...
              <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                <div className="text-sm font-semibold text-red-400">🚨 Knowledge Silos Detected</div>
                <ul className="text-xs text-slate-300 mt-1 space-y-1">
      ...
      {activeTab === 'activity' && (
        <div className="space-y-6">
          ...
          <div className="glass-panel rounded-2xl p-6">
            ...
            <p className="text-xs text-slate-400 mb-4">When does your team commit code? Darker = more activity.</p>
            <div className="overflow-x-auto">
            ...
            <div className="flex items-center gap-4 mt-4 text-xs text-slate-500">
              ...
              <span>More</span>
              <span className="ml-4">⚠️ Weekend activity > 20% may indicate burnout</span>
            </div>
          </div>
